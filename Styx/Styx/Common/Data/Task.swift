...
class Task {
    ...
    var NotifDate: Date                  // int for each choice; minute
    ...
    init(ID: Int64 = 0, LabelID: Int64 = 0, Title: String = "", Due: Date, Detail: String = "", NotifDate: Date, isNotif: Bool = false, isDone: Bool = false, isDeleted: Bool = false, listCompleted: Int = 0, isRepeat: Bool = false, dateToRepeat:Int = 0) {
        self.ID = ID
